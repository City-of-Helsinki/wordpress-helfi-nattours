...
if(function_exists('pll_register_string')) {
    ...
    pll_register_string( 'Fishes', 'Fishes' );
	...
	pll_register_string( 'Cities', 'Cities' );
 ...
 */
function citynature_copy_editor_content( $content ) {
...
function citynature_copy_editor_excerpt( $content ) {
	// Polylang sets the 'from_post' parameter
	if ( isset( $_GET['from_post'] ) ) {
		$my_post = get_post( $_GET['from_post'] );
		if ( $my_post ) {
...
function citynature_copy_editor_title( $content ) {
	// Polylang sets the 'from_post' parameter
	if ( isset( $_GET['from_post'] ) ) {
		$my_post = get_post( $_GET['from_post'] );
		if ( $my_post ) {
...
add_filter( 'default_content', 'citynature_copy_editor_content' );
add_filter( 'default_excerpt', 'citynature_copy_editor_excerpt' );
add_filter( 'default_title', 'citynature_copy_editor_title' );
