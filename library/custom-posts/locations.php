...
$locations->register_taxonomy( [
    'taxonomy_name'    => 'fishes',
    'singular'         => _x( 'Fish', 'Single', TEXT_DOMAIN ),
    'plural'           => _x( 'Fishes', 'Plural', TEXT_DOMAIN ),
    'partitive'        => _x( 'Fish', 'Partitive', TEXT_DOMAIN ),
    'partitive_plural' => _x( 'Fishes', 'Partitive plural', TEXT_DOMAIN ),
    'slug'             => 'fishes',
    [
        'query_var' => true,
        'rewrite'   => [
